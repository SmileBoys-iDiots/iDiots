...
public abstract class ServerBasePacket {
	...
	protected void writeBitParty(int value1, int value2) {
		String str1 = Integer.toBinaryString(value1);
		String str2 = Integer.toBinaryString(value2);
		//if (value1 <= 32767) str1 = "0" + str1;
		String str3 = str2 + str1;
		writeParty(Long.valueOf(str3, 2).longValue());
	}

	protected void writeParty(long value) {
		int i = 0;
	...
	public int bitlengh(int obj) {
		...
		if (obj < 0) {
			BigInteger b = new BigInteger("18446744073709551615");
			while (BigInteger.valueOf(obj).and(b).shiftRight((length + 1) * 7)
					.longValue() > 0) {
				length++;
			}
			length++;
	...
	protected void writeSS2(String text) {
		try {
			if (text != null) {

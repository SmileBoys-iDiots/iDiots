...
public class S_ShopBuyList extends ServerBasePacket {
	...
	public S_ShopBuyList(int objid, L1PcInstance pc) {
		...
		if (npcId == 70035 || npcId == 70041 || npcId == 70042 || npcId == 100564) {
			assessedItems = shop.assessTicketsBugBearRace(pc.getInventory());
		}else if (npcId == 72320) {
			assessedItems = shop.assessTicketsDogFight(pc.getInventory());
		} else {

...
public class S_SabuTell extends ServerBasePacket {
	...
	public S_SabuTell(L1PcInstance pc) {
		if (pc.텔대기() || pc.isTeleport() || pc.isDead()
				|| pc.getSkillEffectTimerSet().hasSkillEffect(L1SkillId.데스페라도) || pc.getSkillEffectTimerSet().hasSkillEffect(L1SkillId.DEMOLITION)
				|| pc.getSkillEffectTimerSet().hasSkillEffect(L1SkillId.ETERNITY) || pc.getSkillEffectTimerSet().hasSkillEffect(L1SkillId.PHANTOM)) {
			return;
		}

...
public class S_BerryShopSellList extends ServerBasePacket {

	private static final String _S_BerryShopSellList = "[S] S_BerryShopSellList";

	/**
	 * 가게의 물건 리스트를 표시한다. 캐릭터가 BUY 버튼을 눌렀을 때에 보낸다.
	 */
	public S_BerryShopSellList(int objId) {
		...
		for (int i = 0; i < shopItems.size(); i++) {
			 ...
			 * System.out.println("123"); if(item.getItemId() == 40008){
			 * writeH(0x0827); }else{ writeC(item.getUseType()); writeC(0); }
			 */

...
public class WeaponSkill {
	...
	public static void AkdukSword(L1PcInstance pc, L1Character cha, int weaponid) {
		int[] stunTimeArray = { 1000, 1200, 1300, 1400, 1500, 2000, 2500, 3000,
				3500 };
	...
	public static double ainhasadflash(L1PcInstance pc, L1Character cha, //커츠의검
		...
		if (val >= chance) {
			...
			if (dmg < 30)
				dmg = 30;
			pc.sendPackets(new S_SkillSound(cha.getId(), 18539));
			Broadcaster.broadcastPacket(pc,
					new S_SkillSound(cha.getId(), 18539));
		}
		return dmg;
	}
	...
	public static double getRepperSwordDamage(L1PcInstance pc, L1Character cha, //사신의검
			int enchant) {
		double dmg = 0;
		double plusdmg = 0;
		int chance = _random.nextInt(100) + 1;
	...
	public static double getZerosDamageNpc(L1PcInstance pc, L1Character cha,
			int enchant) {
		double dmg = 0;
		double plusdmg = 0;
		int chance = _random.nextInt(100) + 1;

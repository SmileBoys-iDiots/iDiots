	...
	public void clickItem(L1Character cha, ClientBasePacket packet) {
		try {
			if (cha instanceof L1PcInstance) {
				...
				if(itemId==40218 || itemId==600485 ||itemId==55594 ||itemId==55595 ||itemId== 55596 ||itemId== 55597 
						||itemId== 55598 ||itemId== 600360 ||itemId== 55599
						||itemId==411488||itemId==411533||itemId==600358){
				...
				if (itemId > 40169 && itemId < 40226
					...
					if (pc.isCrown() || pc.isGm()) {
						...
						||(itemId >= 40237 && itemId <= 40264)
						|| (itemId >= 41149 && itemId <= 41153) 
						|| itemId == 411533 || itemId == 600329 
						|| (itemId >= 60530 && itemId <= 60532)
						|| itemId == 600484) {
					useElfSpellBook(pc, useItem, itemId);
				} else if ((itemId > 40264 && itemId < 40278) || itemId == 40279 || itemId == 60199 || itemId == 55593 || itemId == 600486) {
					...
					if (pc.isWarrior() || pc.isGm()) {
						...
						|| itemId >= 41147 && itemId <= 41148 || itemId == 411488 
						|| itemId == 55560 || itemId == 55561 || itemId == 600483) {
					if (pc.isKnight() || pc.isGm()) {
						...
						|| itemId == 72018|| itemId == 72019 || itemId == 72020 || itemId == 55562 || itemId == 600487) {
					if (pc.isDragonknight() || pc.isGm()) {
						...
						|| itemId == 55564 || itemId == 2100199 || itemId == 600359 || itemId == 600488) {
	...
	private void 전사의인장패시브(L1PcInstance pc, L1ItemInstance l1iteminstance) {
		...
		for (int i = 300; i < 307; i++) {
			...
			if (l1iteminstance.getItem().getName().equalsIgnoreCase(s1)) {
				...
				pc.sendPackets(s_skillSound);
				Broadcaster.broadcastPacket(pc, s_skillSound);
				SkillsTable.getInstance().spellMastery(pc.getId(), i,

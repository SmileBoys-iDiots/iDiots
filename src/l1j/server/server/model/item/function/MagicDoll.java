	...
	private void useMagicDoll(L1PcInstance pc, int itemId, L1ItemInstance item) {
		...
		if (isAppear) {
			...
			case 500204: // 1,800초 동안 64초마다 MP 회복 +15, 공격 시 일정 확률로 콜 라이트닝 발동
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"64초마다 MP 회복 +15, 공격 시 일정 확률로 콜 라이트닝 발동"));
				break;
			case 600308: // 1,800초 동안 64초마다 MP 회복 +15, 공격 시 일정 확률로 콜 라이트닝 발동
				npcId = 101142;
				dollType = L1DollInstance.DOLLTYPE_축흑장로;
				consumecount = 50;
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"64초마다 MP 회복 +15, AC-2, 공격 시 일정 확률로 콜 라이트닝 발동"));
				break;
			...
			case 600314:
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"SP+2, 최대 HP+80, AC-2, PvP대미지+2"));
				break;
			case 600315: // 1,800초 동안 근거리 대미지+2,스턴 내성+12,근거리 명중+2
				npcId = 101149;
				dollType = L1DollInstance.DOLLTYPE_축사이클롭스;
				consumecount = 50;
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"근거리 대미지+2,스턴 내성+12,근거리 명중+2, AC-2, PvP대미지+2"));
				break;
			case 600317:// 시어
				npcId = 101151;
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"원거리 대미지+5, 32초마다 HP 회복+30, AC-2, PvP대미지+2"));
				break;
			case 600316:// 나발
				npcId = 101150;
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"스턴 적중+5, 근거리 대미지 +2, 근거리 명중 +2, AC-2, PvP대미지+2"));
				break;
			case 600318:
				npcId = 101152;
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"포우 슬레이어 단계별 대미지+10, 대미지 리덕션+3, AC-2, PvP대미지+2"));
				break;
			case 600319:
				npcId = 101153;
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"공포 적중 +3, 기술 내성 +5,  근거리 대미지,명중+2, AC-2, PvP대미지+2"));
				break;
			case 600320:
				npcId = 101154;
				...
				consumecount = 50;
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage("경험치 +10%, 대미지 감소+2, 64초마다 MP 15회복, AC-2, PvP대미지+2"));
				break;
			...
			case 600321:// 데몬
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"스턴 적중+10, 스턴 내성+12, AC-3, PvP대미지+2, PvP대미지감소+4"));
				break;
			case 600322:// 데스
				npcId = 101156;
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"경험치 +20%, 리덕+5, AC-3, PvP대미지+2, PvP대미지감소+4, 발동:헬파이어"));
				break;
			case 600323:
				npcId = 101157;
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"파괴적중+10, 스턴 내성+12, AC-3, PvP대미지+2, PvP대미지감소+4"));
				break;
			case 600324:
				npcId = 101158;
				...
				consumecount = 50;
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage("스턴 내성+10, SP+3, 마법 적중+5, AC-3, PvP대미지+2, PvP대미지감소+4"));
				break;
			case 600325:
				npcId = 101159;
				...
				consumecount = 50;
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage("공포 적중+5, 스턴 내성+10, AC-3, PvP대미지+2, PvP대미지감소+4"));
				break;	
			case 600326:
				npcId = 101160;
				...
				consumecount = 50;
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage("원거리 대미지+5, 원거리 명중+5, 스턴 내성+10, AC-3, PvP대미지+2, PvP대미지감소+4"));
				break;
			case 600327:
				npcId = 101161;
				...
				consumecount = 50;
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage("AC-5, 포우 슬레이어 단계별 대미지+10, 대미지 감소+3, 스턴내성 +10, PvP대미지+2, PvP대미지감소+4"));
				break;
			...
			case 600259:// 안타라스
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"대미지 감소 +6, 경험치 보너스 25%, 64초마다 MP 회복 15"));
				break;
			case 600263:// 안타라스
				npcId = 1600259;
				dollType = L1DollInstance.DOLLTYPE_안타라스;
			...
			case 600260:// 파푸리온
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"스턴 내성 +8, 공포 내성 +8, 마법 적중 +8, SP +4, 64초마다 MP 회복 5"));
				break;
			case 600264:// 파푸리온
				npcId = 1600260;
				dollType = L1DollInstance.DOLLTYPE_파푸리온;
			...
			case 600261:// 린드비오르
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"스턴 내성 +8, 공포 내성 +8, 원거리 명중 +8, 원거리 대미지 +4, 64초마다 MP 회복 5"));
				break;
			case 600265:// 린드비오르
				npcId = 1600261;
				dollType = L1DollInstance.DOLLTYPE_린드비오르;
			...
			case 600262:// 발라카스
				...
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage(
						"스턴 내성 +8, 공포 내성 +8, 근거리 명중 +8, 근거리 대미지 +4, 64초마다 MP 회복 5"));
				break;
			case 600266:// 발라카스
				npcId = 1600262;
				dollType = L1DollInstance.DOLLTYPE_발라카스;
			...
			case 755:
				...
				consumecount = 50;
				dollTime = 1800;
				pc.sendPackets(new S_SystemMessage("AC-2, 포우 슬레이어 단계별 대미지+10, 대미지 감소+3, 스턴내성 +10"));
				break;

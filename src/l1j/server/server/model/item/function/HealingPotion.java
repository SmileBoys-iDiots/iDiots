...
public class HealingPotion extends L1ItemInstance {
	...
	private void UseHeallingPotion(L1PcInstance pc, int healHp, int gfxid) {
		...
		//투사의 문장
		if (pc.getInventory().getEnchantEquipped(30019, 1) || pc.getInventory().getEnchantEquipped(30020, 1)
				|| pc.getInventory().getEnchantEquipped(30021, 1) || pc.getInventory().getEnchantEquipped(30023, 1)
				|| pc.getInventory().getEnchantEquipped(30024, 1) || pc.getInventory().getEnchantEquipped(30025, 1)) { // 1강
			healHp += (healHp * 0.02) + 2;
		}
		if (pc.getInventory().getEnchantEquipped(30019, 2) || pc.getInventory().getEnchantEquipped(30020, 2)
				|| pc.getInventory().getEnchantEquipped(30021, 2) || pc.getInventory().getEnchantEquipped(30023, 2)
				|| pc.getInventory().getEnchantEquipped(30024, 2) || pc.getInventory().getEnchantEquipped(30025, 2)) { // 2강
			healHp += (healHp * 0.04) + 4;
		}
		if (pc.getInventory().getEnchantEquipped(30019, 3) || pc.getInventory().getEnchantEquipped(30020, 3)
				|| pc.getInventory().getEnchantEquipped(30021, 3) || pc.getInventory().getEnchantEquipped(30023, 3)
				|| pc.getInventory().getEnchantEquipped(30024, 3) || pc.getInventory().getEnchantEquipped(30025, 3)) { // 3강
			healHp += (healHp * 0.08) + 8;
		}
		if (pc.getInventory().getEnchantEquipped(30019, 4) || pc.getInventory().getEnchantEquipped(30020, 4)
				|| pc.getInventory().getEnchantEquipped(30021, 4) || pc.getInventory().getEnchantEquipped(30023, 4)
				|| pc.getInventory().getEnchantEquipped(30024, 4) || pc.getInventory().getEnchantEquipped(30025, 4)) { // 4강
			healHp += (healHp * 0.10) + 10;
		}
		if (pc.getInventory().getEnchantEquipped(30019, 5) || pc.getInventory().getEnchantEquipped(30020, 5)
				|| pc.getInventory().getEnchantEquipped(30021, 5) || pc.getInventory().getEnchantEquipped(30023, 5)
				|| pc.getInventory().getEnchantEquipped(30024, 5) || pc.getInventory().getEnchantEquipped(30025, 5)) { // 5강
			healHp += (healHp * 0.12) + 12;
		}
		if (pc.getInventory().getEnchantEquipped(30019, 6) || pc.getInventory().getEnchantEquipped(30020, 6)
				|| pc.getInventory().getEnchantEquipped(30021, 6) || pc.getInventory().getEnchantEquipped(30023, 6)
				|| pc.getInventory().getEnchantEquipped(30024, 6) || pc.getInventory().getEnchantEquipped(30025, 6)) { // 6강
			healHp += (healHp * 0.14) + 14;
		}
		if (pc.getInventory().getEnchantEquipped(30019, 7) || pc.getInventory().getEnchantEquipped(30020, 7)
				|| pc.getInventory().getEnchantEquipped(30021, 7) || pc.getInventory().getEnchantEquipped(30023, 7)
				|| pc.getInventory().getEnchantEquipped(30024, 7) || pc.getInventory().getEnchantEquipped(30025, 7)) { // 7강
			healHp += (healHp * 0.16) + 16;
		}
		if (pc.getInventory().getEnchantEquipped(30019, 8) || pc.getInventory().getEnchantEquipped(30020, 8)
				|| pc.getInventory().getEnchantEquipped(30021, 8) || pc.getInventory().getEnchantEquipped(30023, 8)
				|| pc.getInventory().getEnchantEquipped(30024, 8) || pc.getInventory().getEnchantEquipped(30025, 8)) { // 8강
			healHp += (healHp * 0.18) + 18;
		}

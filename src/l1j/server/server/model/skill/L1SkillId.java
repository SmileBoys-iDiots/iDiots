...
public class L1SkillId {
	...
	public static final int 출석체크딜레이 = 5000;
	...
	public static final int 초보자도우미클릭딜레이 = 10522;
	public static final int 얼녀성인던딜레이 = 10523;
	...
	public static final int 가입신청딜레이 = 76271;
	public static final int 채팅파티버프 = 76272;

	public static final int 신고딜레이 = 76273;
	public static final int 파티초대딜레이 = 76274;
	...
	public static final int 더블브레이크데스티니 = 511;
	public static final int 카운터배리어베테랑 = 512;
	public static final int 썬더그랩브레이브 = 513;
	public static final int 포우슬레이어브레이브 = 514;
	public static final int 데스페라도앱솔루트 = 515;
	public static final int 다크호스 = 516;
	public static final int 파이널번 = 517;
	public static final int 아우라키아 = 518;
	// SAFE POLY앤 dodo팩

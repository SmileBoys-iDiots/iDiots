...
public class L1TownLocation {
	...
	public static final int TOWNID_claudia = 21;
	...
	public static int getTownIdByLoc(int x, int y) {
		int townid = 0;
		if (x >= TOWN_LOC_MIN_ADEN_LOCATION[0]
	...
	public static int getTownIdByNpcid(int npcid) {
		...
		/*
		 * case 70654: // case 50039: // case 70045: // case 70044: // case
		 * 70664: // case 4200002: // 에바 추가물품상점 case 4500165: case 4500173: case
		 * 4500170: town_id = TOWNID_WERLDAN; break;
		 */

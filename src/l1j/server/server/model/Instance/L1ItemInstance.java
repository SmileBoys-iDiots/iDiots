...
public class L1ItemInstance extends L1Object {
	...
	public int getMr() {
		...
		if (itemid == 20078 || itemid == 20079 || itemid == 120079 || itemid == 21137 || itemid == 20074
				|| itemid == 120074 || itemid == 20049 || itemid == 20050) {
...
//				os.writeC(1);
			...
			if (itemId == 30081) { //집행 근거리 치명타
				os.writeC(50);
				os.writeD(getEnchantLevel() + 1);
		    }
			/** 커츠 투사 휘장 **/
			if (itemId == 231006) {
				switch (getEnchantLevel()) {
			...
			if (itemId >= 420112 && itemId <= 420115) {
				...
				case 7:
					...
					os.writeC(4);
					os.writeC(73); // 발동
					os.writeS("발라카스의 일격(치명타4%)");
					break;
				case 8:
					os.writeC(97);
					os.writeC(5);
					os.writeC(73); // 발동
					os.writeS("발라카스의 일격(치명타5%)");
					break;
				case 9:
					os.writeC(97);
					os.writeC(6);
					os.writeC(73); // 발동
					os.writeS("발라카스의 일격(치명타6%)");
					break;
				case 10:
					os.writeC(97);
					os.writeC(6);
			...
			if (itemId == 230002) { // 예언자의 견갑
				os.writeC(40);
				os.writeC(1); // 마적1
			}
			if (itemId == 222348) { // 신성한 지식의 목걸이
				os.writeC(40);
				os.writeC(2); // 마적1
			}
			...
			if (itemId == 30082 || itemId == 30091 || itemId == 450048) { // 가이아표기부분
				os.writeC(99); // 원거리 치명타+1
				os.writeC(3);
				os.writeC(63); // 대미지 감소
				os.writeC(2);
			...
			if (itemId == 413105) { // 악마왕의활
				os.writeC(99); // 원거리 치명타+1
				os.writeC(1);
			}
			if (itemId == 189 || itemId == 100189 || itemId == 293) { // 흑왕궁,악몽의장궁
				os.writeC(99); // 원거리 치명타+1
				os.writeC(3);
			}
...
*/
			...
			/** 귀걸이,목걸이 +7부터 스턴내성 **//*
			if (getItem().getGrade() != 3 && itemType2 == 2
					&& (getItem().getType() == 8 || getItem().getType() == 12 && getEnchantLevel() > 6)) { // 귀걸이 목걸이
				switch (getEnchantLevel()) {
				case 7:
					os.writeC(117);
					os.writeC(2);
			...
			if (itemId == 421221) { // 조이의 유물(순간이동지배)
				switch (getEnchantLevel()) {
				case 0:
					os.writeC(39);
					os.writeS("\\fG아데나: \\aA+4%");
			...
			*/
			...
			} else if (itemId == 21252) { //// 스냅퍼 체력 확률 리덕
				switch (getEnchantLevel()) {
				case 6:
					os.writeC(64);
					os.writeC(1);
			...
			if (getItem().getMagicName() != null && getItem().getItemId() != 203026 || getItem().getItemId() != 203025 || getItem().getItemId() != 90084 ||
					getItem().getItemId() != 7227 || getItem().getItemId() != 293){
				os.writeC(74);
				os.writeS(getItem().getMagicName());
			}
			
			if (getItem().getItemId() == 203026 || getItem().getItemId() == 203025 && getEnchantLevel() >= 10){
				os.writeC(74);
				os.writeS("싸울 혼");
			}
			
			if (getItem().getItemId() == 90084 && getEnchantLevel() >= 10){
				os.writeC(74);
				os.writeS("섬멸");
			}
			
			if (getItem().getItemId() == 7227 && getEnchantLevel() >= 10){
				os.writeC(74);
				os.writeS("나락");
			}
			
			if (getItem().getItemId() == 293 && getEnchantLevel() >= 10){
				os.writeC(74);
				os.writeS("악몽");
			}
	...
	public int getTechniqueTolerance() {
		...
		} else if ((getItemId() >= 200852 && getItemId() <= 200854) || (getItemId() >= 30031 && getItemId() <= 30033)) { //용티 스턴내성
		...
		if ((getItemId() >= 900020 && getItemId() <= 900023)) {
		...
		if (((getItem().getItemId() >= 21246 && getItem().getItemId() <= 21253)) && getEnchantLevel() > 5) { //스냅퍼기술내성
	...
	public int getSpiritTolerance() {
		...
		if (getItemId() == 20049 || getItemId() == 20050 || getItemId() == 22009 || getItemId() == 122009) {
			result += enchantLevel > 4 ? enchantLevel - 4 : 0;
			if (result > 7) {
				result = 7;
			}
		...
		if (getItemId() >= 30031 && getItemId() <= 30033) {
	...
	public int getAllTolerance() {
		...
		if (getItemId() >= 20494 && getItemId() <= 20496) {
			result += enchantLevel > 5 ? enchantLevel - 5 : 0;
			if (result > 5) {
				result = 5;
			}
	...
	public int getDragonLangHit() {
		...
		if (getItemId() == 30080 || getItemId() == 30081) { //히페 공포 용언적중
			result += enchantLevel > 0 ? enchantLevel : 0;
			if (result > 11) {
				result = 11;
			}

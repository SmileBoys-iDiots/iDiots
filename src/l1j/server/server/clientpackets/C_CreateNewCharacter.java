...
public class C_CreateNewCharacter extends ClientBasePacket {
	 ...
	 * new int [][] {{ 32707, 32715, 32714, 32704, 32708 }, // 숨계 X { 32785,
	 * 32780, 32774, 32775, 32780 }};// 노섬 X private static final int[][]
	 * START_LOC_Y = new int [][] {{ 32880, 32870, 32877, 32876, 32870 }, // 숨계Y
	 * { 32783, 32790, 32789, 32783, 32781 }};// 노섬Y private static final
	 * short[] MAPID_LIST = new short[] { 68, 69, 69, 68, 69, 68, 69 };
	 */
	public static final int[] MALE_LIST = new int[] { 0, 61, 138, 734, 2786,
			6658, 6671, 12490,18520 };
	public static final int[] FEMALE_LIST = new int[] { 1, 48, 37, 1186, 2796,
			6661, 6650, 12494, 18499 };

	// public static final int[][] START_LOC_X = new int [][] {{ 32683, 32686,
	// 32684, 32683, 32684 }, // 숨계 X
	// { 32683, 32686, 32684, 32683, 32684 }};// 노섬 X
	// public static final int[][] START_LOC_Y = new int [][] {{ 32853, 32856,
	// 32851, 32856, 32850 }, // 숨계Y
	// { 32853, 32856, 32851, 32856, 32850 }};// 노섬Y

	public static final short[] MAPID_LIST = new short[] { 3, 3, 3,
		3, 3, 3, 3, 3, 3 };
	...
	private static void initNewChar(LineageClient client, L1PcInstance pc)
		 ...
		 * Beginner.getInstance().신규경험치지급단GiveItem(pc); }else{

...
public class MonsterBookTable {
	...
	public int getQuest1(int num) {
		...
		case 533: case 549: case 552: case 553:	case 554: case 555:	case 556: case 586:	case 599: case 607: case 608: case 609: case 666:{	
			return 10; //이부분 10은 보스몹 1단 킬카운트 보상인거같구
		}
        case 558: 
        case 559: 
        case 560: 
        ...
        case 575: 
        case 576: {
            return 50; //이부분은 제가 추가 정예몹 1단보상 50킬카운트
         }
		}
			return 500;		//나머지 일반몹 1단 보상 500카운트
	}

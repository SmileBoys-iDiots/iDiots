	...
	public void loadbot() {
		...
		try {
			...
			while (rs.next()) {
				...
				newPc.getGfxId().setGfxId(newPc.get_sex());
				newPc.getGfxId().setTempCharGfx(newPc.get_sex());
				...
				newPc.setClanRank(L1Clan.CLAN_RANK_PRINCE);
				newPc.setElfAttr(0);
				newPc.set_PKcount(0);
				newPc.setExpRes(0);
				...
				newPc.setMemo(rs.getString("clan_memo"));
				newPc.setKills(0);
				newPc.setDeaths(0);

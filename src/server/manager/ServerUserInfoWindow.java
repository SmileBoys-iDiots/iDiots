...
public class ServerUserInfoWindow extends JInternalFrame {
	...
	public void initialize(String windowName, int x, int y, int width, int height, boolean resizable, boolean closable) {
		...
		try {		
			...
			lbl_Helper = new JLabel("선택후 클릭 >");
			lbl_Helper.setForeground(Color.yellow);
...
//			});
			...
			col2.addComponent(btn_Search, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE)
				.addComponent(btn_Ban, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE);
...
//		        .addComponent(btn_Present, GroupLayout.PREFERRED_SIZE, 70, GroupLayout.PREFERRED_SIZE);
			...
			col3.addComponent(chk_Infomation, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE)
			    .addComponent(btn_NoChat, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE);
			
			col4.addComponent(btn_Present, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE);
			col5.addComponent(btn_Poly, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE);
		...
		try {
			...
			if (chk_Infomation.isSelected()) {
				...
				if (player != null) {
					...
					// 인형에 의한 수치
					int dollWeight = 0;
					for (L1DollInstance doll : player.getDollList()) {
					...
					for (int i = 0; i < lbls.length; i++) {
						...
						switch (index) {
							...
							case 12:
								...
								for (L1DollInstance doll : player.getDollList()) {
								charInfo[3] = String.valueOf(doll.getDamageReductionByDoll());
								}
								break;
							default:
								break;
